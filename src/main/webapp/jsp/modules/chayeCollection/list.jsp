...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">茶叶收藏管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">茶叶收藏列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">茶叶收藏列表</h3>
    ...
    <script>
        ...
        function getDataList() {
            http("chayeCollection/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                chayeCollectionDelete: 1,
                //本表的
        ...
        function setDataRow(item, number) {
            ...
            //类型
            var chayeCollectionTypesCell = document.createElement('td');
            chayeCollectionTypesCell.innerHTML = item.chayeCollectionValue;
            row.appendChild(chayeCollectionTypesCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("chayeCollection/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addchayeCollection", "addchayeCollection");
            window.location.href = "add-or-update.jsp"
        }
