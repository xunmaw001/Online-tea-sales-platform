            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">茶叶订单登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="chayeName" name="chayeName" class="form-control"
                                                   v-model="ruleForm.chayeName" readonly>
                                        </div>


                                    <div class="form-group col-md-6">
                                        <label>茶叶照片</label>
                                        <img id="chayePhotoImg" width="100" height="100">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label>茶叶类型</label>
                                        <input style="width: 450px" id="chayeValue" name="chayeValue" class="form-control"
                                               v-model="ruleForm.chayeValue" readonly>
                                    </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="chayeKucunNumber" name="chayeKucunNumber" class="form-control"
                                                   v-model="ruleForm.chayeKucunNumber" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="chayePrice" name="chayePrice" class="form-control"
                                                   v-model="ruleForm.chayePrice" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="chayeOldMoney" name="chayeOldMoney" class="form-control"
                                                   v-model="ruleForm.chayeOldMoney" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="chayeNewMoney" name="chayeNewMoney" class="form-control"
                                                   v-model="ruleForm.chayeNewMoney" readonly>
                                        </div>


                                        <div class="form-group col-md-6">
                                            <label>点击次数</label>
                                            <input style="width: 450px" id="chayeClicknum" name="chayeClicknum" class="form-control"
                                                   v-model="ruleForm.chayeClicknum" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="chayeOrderUuidNumber" name="chayeOrderUuidNumber" class="form-control"
                                               v-model="ruleForm.chayeOrderUuidNumber" readonly>
                                    </div>

                                <input id="addressId" name="addressId" v-model="ruleForm.addressId" readonly type="hidden">
                                <input id="chayeId" name="chayeId" v-model="ruleForm.chayeId" readonly type="hidden">
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="chayeOrderTruePrice" name="chayeOrderTruePrice" class="form-control"
                                               v-model="ruleForm.chayeOrderTruePrice" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="chayeOrderCourierName" name="chayeOrderCourierName" class="form-control"
                                               v-model="ruleForm.chayeOrderCourierName" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="chayeOrderCourierNumber" name="chayeOrderCourierNumber" class="form-control"
                                               v-model="ruleForm.chayeOrderCourierNumber" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>订单类型</label>
                                    <input style="width: 450px" id="chayeOrderValue" name="chayeOrderValue" class="form-control"
                                           v-model="ruleForm.chayeOrderValue" readonly>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>支付类型</label>
                                    <input style="width: 450px" id="chayeOrderPaymentValue" name="chayeOrderPaymentValue" class="form-control"
                                           v-model="ruleForm.chayeOrderPaymentValue" readonly>
                                </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "chayeOrder/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.chayeContent != null && ruleForm.chayeContent != 'null' && ruleForm.chayeContent != '') {
            var chayeContentUeditor = UE.getEditor('chayeContentEditor');
                chayeContentUeditor.ready(function () {
                    ...
                    chayeContentUeditor.setDisabled('fullscreen');
            });
        }
    }
