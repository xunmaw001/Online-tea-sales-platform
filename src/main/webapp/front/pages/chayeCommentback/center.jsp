    ...
    <ul class="layui-nav layui-nav-tree">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="chayeCommentbackText" id="chayeCommentbackText" lay-verify="required" placeholder="评价内容" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`chayeCommentback/session`, 'get', {}, function (data) {
                    // 表单赋值
