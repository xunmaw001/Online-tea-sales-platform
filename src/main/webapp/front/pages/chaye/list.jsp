                ...
                <div class="ng-inside-box ng-fault ng-container" aos="fade-up">
                    <div>
                        <div v-for="(item,index) in dataList" v-bind:key="index" class="col-md-3 col-sm-3 col-xs-6 w3gallery-grids">
                            <div class="imghvr-hinge-right figure" style="width: 100%" @click="jumpCheck('../chaye/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            // 获取列表数据
            http.request('chaye/list', 'get', param, function(res) {
