    ...
    <ul class="layui-nav layui-nav-tree">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="chayeCollectionTypes" id="chayeCollectionTypes">
                                    <option v-for="item in chayeCollectionTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
								</select>
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`chayeCollection/session`, 'get', {}, function (data) {
                    // 表单赋值
			   ...
			   function chayeCollectionTypesSelect() {
				   //填充下拉框选项
				   http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=chaye_collection_types", "GET", {}, (res) => {
					   if(res.code == 0){
