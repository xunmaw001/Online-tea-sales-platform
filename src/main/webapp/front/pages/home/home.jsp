                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="portfolio" id="gallery">
                        <div class="portfolio-agile">
                            <div class="main">
                                <div v-for="(item,index) in chayeList" v-bind:key="index" class="view view-seventh" style="width: 23%;height: 300px">
                                    <a @click="jumpCheck('../chaye/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" class="b-link-stripe b-animate-go thickbox">
                                        <img :src="item.chayePhoto?item.chayePhoto.split(',')[0]:''"  style="height: 350px;width:100%;" />
                                        <div class="mask">
                                            <h4>
                                                <b>{{item.chayeName}}</b>
                                                <br>
                                                <b v-if="item.chayeNewMoney">{{item.chayeNewMoney}} RMB</b>
                                                <b v-else>{{item.chayeValue}}</b>
                                            </h4>
                                        </div>
                                    </a>
                                </div>
